<template>
  <dialog ref="winnerModal" id="winner">
    ...
    <main>
      <span class="fancytext_big">{{ game.winner }}</span>
    </main>
    <footer v-if="game.gameEnd">
      <button type="button" @click="game.client.returnToLobby">Lobby</button>
      <button type="button" @click="game.client.leaveLobby">Home</button>
    </footer>
  </dialog>
